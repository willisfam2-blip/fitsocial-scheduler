...
async function save(job){await put(`${PREFIX}${job.id}.json`,JSON.stringify(job),{access:'public',contentType:'application/json',cacheControlMaxAge:60,addRandomSuffix:false,allowOverwrite:true});}
